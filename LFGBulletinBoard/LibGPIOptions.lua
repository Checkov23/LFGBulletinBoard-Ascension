...
function Options.AddPanel(Title,noheader,scrollable)
	...
	Options.Panel["scrollChild"..c]:SetHeight(100)
...
function Options.AddColorButton(DB,Var,Init,Text,width)
	...
	if but.ColTex.SetColorTexture then but.ColTex:SetColorTexture(1,1,1,1) else but.ColTex:SetTexture(1,1,1,1) end -- GBBCOMPAT_OK
