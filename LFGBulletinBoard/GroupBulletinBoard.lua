...
GBB.NotifySound="TellMessage"


local PartyChangeEvent={ "PARTY_MEMBERS_CHANGED", "RAID_ROSTER_UPDATE", "PLAYER_ENTERING_WORLD", "PLAYER_REGEN_DISABLED"}
...
function GBB.PhraseChannelList(...)
	local t={}
	for id,info in pairs(GBB.Compat.ParseChannelList(...)) do
		t[id]={name=info.name,hidden=info.hidden}
	end
